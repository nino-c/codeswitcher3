...
gulp.task('_css-build', function () {
    return gulp.src(['src/scss/**/*.scss', 'src/scripts/app/**/*.scss'])
        .pipe(sassGlob())
...
gulp.task('_tpls-build', function () {
    return gulp.src(['src/templates/**/*.html', 'src/scripts/app/**/*.html'])
...
gulp.task('_build', ['_css-build', '_css-vendor-build', '_vendorJS-build', '_tpls-build', '_modernizr-build',
